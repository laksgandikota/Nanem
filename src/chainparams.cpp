...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000000e58db66511eaea6dd7051a3d7d3041731b1e79487afcc320de39838b"); //0
...
//        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_main, pnSeed6_main + ARRAYLEN(pnSeed6_main));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x00000000e58db66511eaea6dd7051a3d7d3041731b1e79487afcc320de39838b")}
            }
        };
...
//        vSeeds.emplace_back("testnet-seed.bitcoin.schildbach.de", false);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("000000007a5ef61ffacb1db816c0bb26664f84937408ecfa2f767bb9d914bfad")},
            }
        };
